...
const icons = { technology: '⚡', science: '🔬', philosophy: '🧠', history: '📜', nature: '🌿', health: '🧘', space: '🌌', default: '◇' }
...
export default function ResultCard({ result, index }) {
  ...
  return (
    ...
    onMouseEnter={e => { e.currentTarget.style.borderColor = 'rgba(255,255,255,0.14)'; e.currentTarget.style.background = 'var(--surface2)'; e.currentTarget.style.transform = 'translateY(-1px)'; }}
    onMouseLeave={e => { e.currentTarget.style.borderColor = 'rgba(255,255,255,0.07)'; e.currentTarget.style.background = 'var(--surface)'; e.currentTarget.style.transform = 'translateY(0)'; }}
    >
      {/* Header */}
