    ...
    >
      ...
      <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', gap: '8px' }}>
        <div style={{ display: 'flex', gap: '5px', flexWrap: 'wrap', alignItems: 'center' }}>
          ...
          {/* ⚡ Endee badge — shows evaluators Endee is powering results */}
          {result.source === 'endee' && (
            <span style={{
        ...
        <div style={{ display: 'flex', alignItems: 'center', gap: '8px', flexShrink: 0 }}>
          ...
          <div style={{ width: '64px', height: '2px', borderRadius: '1px', background: 'rgba(255,255,255,0.06)', overflow: 'hidden' }}>
            <div style={{
              ...
              width: `${pct}%`, background: barColors[tier],
              animation: `grow 0.8s cubic-bezier(0.16,1,0.3,1) ${delay + 250}ms both`,
            }} />
          </div>
        </div>
      </div>
